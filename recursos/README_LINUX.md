...
Em Ubuntu/Debian, instala as ferramentas básicas necessárias:
...
Noutras distribuições, consulta os requisitos oficiais:
...
Descarrega a versão adequada à tua distribuição em:
